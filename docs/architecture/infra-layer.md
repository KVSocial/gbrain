...
| `src/core/embedding.ts` | OpenAI/OpenRouter embedding with batch, retry, backoff |
...
| `src/core/search/expansion.ts` | Multi-query expansion via Anthropic or OpenRouter chat models |
